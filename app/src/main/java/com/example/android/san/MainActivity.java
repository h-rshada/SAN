...
*/
    ...
    public void putUserInfo() {
        ...
        Log.d("Url", "http://192.168.0.22:8001/routes/server/app/userData.rfa.php?name=" + name + "&auth_id=" + userProfile.getId() + "&phone=" + phone + "&address=" + address + "&email=" + email2);
        urlRequest.setUrl("http://192.168.0.22:8001/routes/server/app/userData.rfa.php?name=" + name + "&auth_id=" + userProfile.getId() + "&phone=" + phone + "&address=" + address + "&email=" + email2);
    ...
    /*   public void checkData() {
        ...
        urlRequest = UrlRequest.getObject();
        urlRequest.setContext(getApplicationContext());
        Log.d("checkData: ","http://192.168.0.22:8001/routes/server/app/checkUserInfo.rfa.php?auth_id=" + userProfile.getId() );
